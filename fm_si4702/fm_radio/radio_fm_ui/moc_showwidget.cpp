...
static const char qt_meta_stringdata_ShowWidget[] = {
    "ShowWidget\0\0UpdateValue()\0"
};

const QMetaObject ShowWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ShowWidget,
      qt_meta_data_ShowWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ShowWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ShowWidget))
